...
const std::vector<InstrLUTRow> CS_LUT = {
	...
	//
	{
		...
		2,
		CB_HELP(READ_IP && (try_parse_integer(args[1], cs.arg.u))),
	},
	{
		OPCode::AIRDM,
		"AIRDM",
	...
	//
	{
		...
		"LOOP",
		"<iterations (uint32)>",
		"LOOP - opens a Scope between itself and matching END and repeats the code specified number of times",
		1,
		nullptr,
	},
	{
